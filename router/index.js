...
const deleteFunction = require("../controllers/deleteFunc");
...
renderRouter.route("/signIn").get(getData.getSignInPage).post(signInValidation.userNameValidation, signInValidation.emailValidation, signInValidation.passwordValidation, userFunction.postSignIn);
...
renderRouter.post("/delete", deleteFunction.postDelete);
